...
if __name__=='__main__':
    ...
    o.add_option('--plc_dir',dest='plc_dir',default='/data3/tiago/Marta-Reborn-TheUntoldStory/',help='input directory')
    o.add_option('--pname',dest='pname',default='pinocchio.Marta0.plc.out.',help='Pinocchio filename')
